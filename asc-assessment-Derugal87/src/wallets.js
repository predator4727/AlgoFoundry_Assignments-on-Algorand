...
const sendAlgoSignerTransaction = async (txns, algodClient) => {
    ...
    if (typeof algorand !== "undefined") {
        ...
        //     try {
        //         // Get the binary and base64 encode it
        //         let binaryTxns = txns.toByte();
        //         let base64Txns = algorand.encoding.msgpackToBase64(binaryTxns);
...
const sendAlgoSignerTransactionOptIn = async (txn, algodClient) => {
    const algorand = window.algorand;
...
export default {
    ...
    sendAlgoSignerTransactionOptIn
};
